...
$( "#findCheque" ).click(function() {  
   ...
   console.log(bunit,Agrp,SExeCode,newdate);
      if((SExeCode != null && SExeCode != "" && SExeCode != "- Choose SalesExecutiveCode -") && (newdate!=null && newdate != "")){
            $.ajax({
                         ...
                         //  console.log(data);
                           ...
                           var CRreport =[];
                               for(var i=0; i<response.length; i++){
                                   ...
                                   var Total = Number(At30)+Number(At90)+Number(At120)+Number(At365);
                                   var Bunit = response[i].BusinessUnit;
                                   report = [ActGrp,Dlrs,SEcode,At30,At90,At120,At365,Total,i,Bunit,Day30,Day90,Day120,Day365]; 
                           ...
                           $('#CRetreport').DataTable( {
                               ...
                               columns: [
                                   ...
                                   { title: "Cheque Returned in last 30 Days",
                                    "render": function (row, data, type, meta) {
                                       if(type[3] != '0.00'){
                                           ...
                                           data = '<a href="#" id=  \'crbefore30-' + type[8] + '\' onclick="fetchChequeDetail(\'' + type[9] + '\' , \'' + type[0] + '\' , \'' + type[1]+ ' \', \'' + 30 + '\', \'crbefore30-' + type[8] + '\');">'+row1+'  ('+type[10]+')' +' </a>'; // to get individual cheque details
                                       }else{
                                           data = "-";
                                           }
                                        return data;
                                   ...
                                   { title: "Cheque Returned in last 90 Days",
                                    "render": function (row, data, type, meta) {
                                           ...
                                           if(type[4] != '0.00'){
                                               ...
                                               data = '<a href="#" id= \'crbefore90-' + type[8] + '\' onclick="fetchChequeDetail(\'' + type[9] + '\' , \'' + type[0] + '\' , \'' + type[1]+ ' \', \'' + 90 + '\', \'crbefore90-' + type[8] + '\');">'+row1+'  ('+type[11]+')' +' </a>';;
                                           }else{
                                               data = "-";
                                               }
                                            return data;
                                   ...
                                   { title: "Cheque Returned in last 120 Days" ,
                                    "render": function (row, data, type, meta) {
                                      ...
                                      if(type[5] != '0.00'){
                                       ...
                                       data = '<a href="#" id=  \'crbefore120-' + type[8] + '\' onclick="fetchChequeDetail(\'' + type[9] + '\' , \'' + type[0] + '\' , \'' + type[1]+ ' \', \'' + 120 + '\', \'crbefore120-' + type[8] + '\');">'+row1+'  ('+type[12]+')' +' </a>';;
                                       }else{
                                       data = "-";
                                       }
                                       return data;
                                   ...
                                   { title: "Cheque Returned > 120 Days" ,
                                    "render": function (row, data, type, meta) {
                                      ...
                                      if(type[6] != '0.00'){
                                       ...
                                       data = '<a href="#" id=  \'crbefore365-' + type[8] + '\' onclick="fetchChequeDetail(\'' + type[9] + '\' , \'' + type[0] + '\' , \'' + type[1]+ ' \', \'' + 365 + '\', \'crbefore365-' + type[8] + '\');">'+row1+'  ('+type[13]+')' +' </a>';;
                                       }else{
                                       data = "-";
                                       }
                                       return data;
                                   ...
                                   { title: "Total Amount",
                                      "render": function (row, data, type, meta) {
                                        if(type[7] != '0.00'){
                                             data= $.fn.dataTable.render.number(',','.',2).display(type[7]); 
                                        }else{
                                        data = "-";
                                        }
                                       return data;
