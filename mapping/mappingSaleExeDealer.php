      ...
      <div class="container-fluid">
        ...
        <div >
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Dealer & Sales Executive</li>
            </ol>
        </div>  
        <div class="mr-auto">
            <!-- <input class="btn btn-primary" type="button" id="addRow" name="addRow" data-toggle="modal" data-target="#addRowModal" value="Add Row"> -->
           
            <div class="alert alert-success" hidden role="alert" id="alertMsg"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              </div>
        </div>
        <!-- Page Content -->
        <div class="card mb-3">
...
<script src="../js/DataTables/Buttons-1.5.6/js/buttons.print.min.js"></script>
  ...
  <script src="../jsscripts/mapSEandDL.js"></script>
